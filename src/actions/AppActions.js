...
import {
    ...
    LISTA_CONTATO_USUARIO, MODIFICA_MENSAGEM, ENVIA_MENSAGEM, ENVIA_MENSAGEM_SUCESSO, 
    ENVIA_MENSAGEM_ERRO, LISTA_CONVERSA_USUARIO, LISTA_CONVERSAS_USUARIO
} from './types';
...
export const enviarMensagem = (mensagem, contatoNome, contatoEmail) => {
    console.log(`mensagem  ${mensagem} ${contatoNome} ${contatoEmail}`);
...
export const conversaUsuarioFetch = contatoEmail => {
    console.log('***INICIO***');
    console.log('conversaUsuarioFetch()');
    // Compor os emais na base 64
    const { currentUser } = firebase.auth();
    const usuarioEmail = currentUser.email;
    let usuarioEmailB64 = b64.encode(usuarioEmail);
    let contatoEmailB64 = b64.encode(contatoEmail);
    console.log('usuarioEmail ' + usuarioEmail);
    console.log('contatoEmail ' + contatoEmail);
    console.log('***FIM***');
